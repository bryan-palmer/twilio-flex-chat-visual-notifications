# Task List Chat Item - Unread Notification

Twilio Flex Plugin that displays a thin red bar under a chat task list item when an unread message exists.
...
```bash
cd plugin-chat-visual-notifications
